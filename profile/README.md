...
## The models
The scope of RDMAI model development has been selected based on environmental impact, stakeholder needs, scalability and the potential of AI to provide benefits over current approaches. We have open sourced a suite of AI/ML and remote sensing models. This includes: 
...
📈 [**Open Anamoly Detection Model:**](https://github.com/Cognizant-RDMAI/Open-Anomaly-Detection-Model) Leveraging unsupervised machine learning and signal processing to cluster and interpret anomalies in river water.
